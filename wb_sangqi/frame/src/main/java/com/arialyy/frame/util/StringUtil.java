...
public class StringUtil {
   ...
   *
   * @param str 字符串
   * @param styleStr 需要加粗高亮的字符串
   */
  public static SpannableStringBuilder BoldAndHighLightStr(String str, String styleStr, int color) {
    int start = str.indexOf(styleStr);
    int end = start + styleStr.length();
    if (start == -1) {
      return null;
    }
