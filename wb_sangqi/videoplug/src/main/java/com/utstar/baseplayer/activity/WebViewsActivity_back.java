...
//
//public class WebViewsActivity_back extends FragmentActivity {
...
//        String datas, String params) {  //打开第三方APK
...
//        }
//      }
//      WebViewsActivity_back.this.startActivity(intent);
//    }
//
//    @JavascriptInterface public String getValue(String key) { //获得共享信息
...
//
//    @JavascriptInterface public void goBack() { //回到webview上一页，若无，退出
...
//            webView.goBack();
//          } else {
//            WebViewsActivity_back.this.finish();
//          }
//        }
//      });
//    }
//
//    @JavascriptInterface public void finish() { //退出页面
...
//            .add(R.id.player_window, mMediaplayerFragment)
//            .commit();
//      }
//    }
//
//    @JavascriptInterface public int openDefaultPlayer(final String playList) {
//      init();
...
//    }
//
//    @JavascriptInterface public int setBreakpoint(int position) {
//      init();
...
//    }
//
//    @JavascriptInterface public int setDisplay(final int left, final int top, final int width,
//        final int height) { //设置小窗口长宽
//      APPLog.printInfo(
//          "setDisplay:left->" + left + "/top->" + top + "/width->" + width + "/height->" + height);
//      mIsDefualtPlayer = false;
//      mIsFullScreen = width == FrameLayout.LayoutParams.MATCH_PARENT
...
//    }
//
//    @JavascriptInterface public int setDataSource(String url) { //设置播放地址
...
//        Map<String, String> header = new WeakHashMap<>();
//        header.put("Cookie", session);
//        ToastUtil.getInstace().showToastByString(WebViewsActivity_back.this, "session ==> " + session, 20);
//        util.get(url, header, new HttpUtil.AbsResponse() {
//          @Override public void onResponse(String data) {
//            super.onResponse(data);
//            ToastUtil.getInstace().showToastByString(WebViewsActivity_back.this, "url ==> " + data, 20);
//            FL.d(this, "url ==> " + data);
//          }
//
//          @Override public void onError(IOException e) {
//            super.onError(e);
//            ToastUtil.getInstace().showToastByString(WebViewsActivity_back.this, "error " + e.getMessage(), 20);
//            FL.d(this, "error " + e.getMessage());
//          }
//        });
//
//        //try {
...
//        //} catch (Exception e) {
//        //  ToastUtil.getInstace()
//        //      .showToastByString(WebViewsActivity.this, "exception:" + e.getMessage(), 20);
//        //  return -1;
//        //}
...
//    }
//
//    @JavascriptInterface public int setDataSourceList(final String urlList) { //设置播放地址集合
//      APPLog.printInfo("setDataSourceList\n" + "----------\n" + "playList->" + urlList + "\n");
//      mIsNeedWait = true;
//      init();
//      runOnUiThread(new Runnable() {
...
//    }
//
//    @JavascriptInterface public int start() { //开始播放
//      init();
...
//    }
//
//    @JavascriptInterface public int play() { //开始播放，这里指暂停后开始播放
//      mIsNeedWait = true;
//      init();
//      runOnUiThread(new Runnable() {
//        @Override public void run() {
...
//    }
//
//    @JavascriptInterface public int pause() { //暂停播放
//      mIsNeedWait = true;
//      init();
//      runOnUiThread(new Runnable() {
//        @Override public void run() {
...
//    }
//
//    @JavascriptInterface public int getDuration() { //获得总时长
//      init();
//      return mMediaplayerFragment.getDuration();
//    }
//
//    @JavascriptInterface public int getCurrentPosition() { //获得当前时长
//      init();
//      return mMediaplayerFragment.getCurrentPosition();
//    }
//
//    @JavascriptInterface public int seekTo(final int position) { //快进/退
//      mIsNeedWait = true;
//      init();
//      runOnUiThread(new Runnable() {
//        @Override public void run() {
...
//    }
//
//    @JavascriptInterface public int release() { //终止播放
//      init();
...
//    }
//
//    @JavascriptInterface public int fullScreen() { //全屏播放
...
//    }
//
//    @JavascriptInterface public int exitFullScreen() { //退出全屏播放
