...
import com.utstar.appstoreapplication.activity.databinding.ActivityTemp3Binding;
...
public class TempActivity_3 extends BaseActivity<ActivityTemp3Binding> {
  @Override protected int setLayoutId() {
    return R.layout.activity_temp_3;
  }
