...
import com.utstar.appstoreapplication.activity.databinding.ActivityTemp1Binding;
...
public class TempActivity_1 extends BaseActivity<ActivityTemp1Binding> {
  @Override protected int setLayoutId() {
    return R.layout.activity_temp_1;
  }
